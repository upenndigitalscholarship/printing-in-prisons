...
<div style="text-align: justify; margin-bottom: 20px;">
    <div style="float: right; margin-left: 20px; width: 40%; clear: both;">
        <img src="record.png" alt="Incarceration Record" style="width: 100%;">
...
<div style="text-align: justify; margin-bottom: 20px;">
    <div style="float: left; margin-right: 20px; width: 40%; clear: both;">
        <img src="umpire.png" alt="Newspaper: The Umpire  (659)" style="width: 100%;">
        <p style="font-size: 0.7em; text-align: center; color: gray; margin-top: 5px;">
...
<div style="text-align: justify; margin-bottom: 20px;">
    <div style="float: right; margin-left: 20px; width: 40%; clear: both;">
        <img src="synagogue.png" alt="Photo taken from Eastern State Penitentiary" style="width: 100%;">
        <p style="font-size: 0.7em; text-align: center; color: gray; margin-top: 5px;">
