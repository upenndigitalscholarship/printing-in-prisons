...
<div style="text-align: justify; margin-bottom: 20px;">
    <div style="float: right; margin-left: 20px; width: 40%; clear: both;">
        <img src="https://raw.githubusercontent.com/upenndigitalscholarship/printing-in-prisons/main/assets/img/recordgoldstein.png" alt="Incarceration Record" style="width: 100%;">
...
<div style="text-align: justify; margin-bottom: 20px;">
    <div style="https://raw.githubusercontent.com/upenndigitalscholarship/printing-in-prisons/main/assets/img/umpiregoldstein.png"  alt="Newspaper: The Umpire  (659)" style="width: 100%;">
        <p style="font-size: 0.7em; text-align: center; color: gray; margin-top: 5px;">
            This is an article from the Newspaper, the Umpire, which mentions Harry Hasepl
        </p>
    </div>
...
<div style="text-align: justify; margin-bottom: 20px;">
    <div style="float: right; margin-left: 20px; width: 40%; clear: both;">
        <img src="https://raw.githubusercontent.com/upenndigitalscholarship/printing-in-prisons/main/assets/img/synagoguegoldstein.png" alt="Photo taken from Eastern State Penitentiary" style="width: 100%;">
        <p style="font-size: 0.7em; text-align: center; color: gray; margin-top: 5px;">
